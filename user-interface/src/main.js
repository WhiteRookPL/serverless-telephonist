(function (window) {
  ...
  const GET_ON_CALL_DETAILS_API_ENDPOINT = "https://qk98ppo7la.execute-api.eu-central-1.amazonaws.com/operators/current/details";
  const TEST_ON_CALL_API_ENDPOINT = "https://lfhpq8hjq3.execute-api.eu-central-1.amazonaws.com/calls/test";
